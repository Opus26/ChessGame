...
QT_MOC_LITERAL(1, 6, 12), // "changedBoard"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 9), // "isChanged"
QT_MOC_LITERAL(4, 30, 9), // "chessMate"
QT_MOC_LITERAL(5, 40, 5), // "chess"
QT_MOC_LITERAL(6, 46, 17) // "newGameSuggestion"

    },
    "Board\0changedBoard\0\0isChanged\0chessMate\0"
    "chess\0newGameSuggestion"
};
...
void Board::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changedBoard((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->chessMate(); break;
        case 2: _t->chess(); break;
        case 3: _t->newGameSuggestion(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Board::changedBoard)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Board::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Board::chessMate)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Board::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Board::chess)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (Board::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Board::newGameSuggestion)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 0
void Board::changedBoard(bool _t1)
{
