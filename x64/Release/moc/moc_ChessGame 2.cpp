/****************************************************************************
** Meta object code from reading C++ file 'ChessGame.hpp'
**
...
#error "The header file 'ChessGame.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 10, 10), // "nextPlayer"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 7), // "isWhite"
QT_MOC_LITERAL(4, 30, 4), // "play"
QT_MOC_LITERAL(5, 35, 10), // "initialRow"
QT_MOC_LITERAL(6, 46, 13), // "initialColumn"
QT_MOC_LITERAL(7, 60, 8), // "finalRow"
QT_MOC_LITERAL(8, 69, 11) // "finalColumn"

    },
    "ChessGame\0nextPlayer\0\0isWhite\0play\0"
    "initialRow\0initialColumn\0finalRow\0"
    "finalColumn"
};
...
void ChessGame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->nextPlayer((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->play((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< int(*)>(_a[4]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChessGame::nextPlayer)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ChessGame::nextPlayer(bool _t1)
{
